...
class TrimmedModel():
    ...
    def mask_class_unit(self, classid):
        ...
        with open(json_path, "r") as f:
            ...
            for idx in range(len(gatesValueDict)):
                ...
                layer["name"] = name
                layer["shape"] = vec
                # print(gatesValueDict[idx])
            print("class ", str(classid), " activate nums of neurons: ", str(self.test_counter))    
    ...
    def assign_weight(self):
        ...
        if (self.multiPruning == True and len(self.target_class_id) > 1):
            ...
            maskDict = self.mask_class_unit(self.target_class_id[0])
        ...
        #    saver.save(self.sess, 'vggNet/prune.ckpt')
    ...
    def test_accuracy(self, test_images, test_labels):
        ...
        if (self.multiPruning and len(self.target_class_id) > 1):
            print("prediction for multi class", self.target_class_id, "\t\t", test_accuracy)
        else:
            print("prediction for single class", self.target_class_id[0], "\t\t", test_accuracy)
